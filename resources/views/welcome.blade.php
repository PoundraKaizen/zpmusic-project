    ...
    <ul id="menu-list" class="hidden">
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          @else
          <a href="{{ route('login') }}">Guitar</a>
          <a href="{{ route('login') }}">Piano</a>
          <a href="{{ route('login') }}">Drum</a>
          @endauth
        </div>
      </li>      
  ...
  <main>
    ...
    <div class="container3" id="store">
      ...
      <div class="packages">
        <div class="package">
          ...
          @else
          <button class="sign-up" onclick="window.location.href='{{ route('login') }}'">Beli</button>
          @endauth
        </div>
        <div class="package">
    ...
    <section id="rent" class="rent2">
      ...
      <div class="rent-info">
        ...
        @else
        <a href="{{ route('login') }}" class="btn-rent">Sewa Barang</a>
        @endauth
      </div>
    </section>
